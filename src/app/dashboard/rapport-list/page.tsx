...
import { Plus, FileText, Eye, Pencil, MapPin, Building, CheckCircle, Clock, AlertTriangle } from 'lucide-react'
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b bg-muted/50">
              ...
              <th className="text-center py-3 px-4 text-sm font-medium text-muted-foreground">Vannes</th>
              ...
              rapports.map((r) => {
                ...
                const siteAdresse = chantier
                  ...
                  : r.site_adresse
                    ...
                    : '-'
                const nbLots = chantier?.nb_appartements || r.nb_logements || '-'
